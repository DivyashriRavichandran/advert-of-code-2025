...
This repository contains my solutions for [Advent of Code 2025](https://adventofcode.com/2025), an Advent calendar of small programming puzzles. This year features 12 days of puzzles. I solved them using JavaScript.
...
1. Navigate to the puzzle folder
2. Run the solution with Node.js

```
cd name-of-the-puzzle-folder
node index.js
```
